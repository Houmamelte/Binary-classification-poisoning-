...
def create_shared_split(clean_df, poisoned_df,splitter,seed=42):
    non_flipped = poisoned_df[poisoned_df[splitter] != "Yes"]
    ...
    split_map.update({id_: "train" for id_ in poisoned_df[poisoned_df[splitter] == "Yes"]["id"]})
